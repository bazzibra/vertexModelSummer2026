...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function last_timestep_extractor(inputFile,boolDynamic)
...
if boolDynamic == '0'
    outputFile = erase(inputFilename,"out") + "relaxed.txt"; 
else
    outputFile = inputFilename + "_lasttimestep.txt"; 
end
...
inputFullFile = fullfile(projectRoot,'input_files',inputFile); 
