...
dynamic.exe: DynamicMain.cpp 
	$(CXX) $(CXXFLAGS) AGCell.cpp Tissue.cpp CellClass.cpp DynamicEdge.cpp DynamicMain.cpp DynamicTissue.cpp EdgeClass.cpp SharedConstants.cpp TissueClass.cpp VectClass.cpp VertexClass.cpp -o dynamic.exe
