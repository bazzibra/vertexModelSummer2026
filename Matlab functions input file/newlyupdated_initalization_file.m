...
% --- Updated Constants to match target output exactly ---
A0 = 2812.500000;
GAMMA = 1.000000;
t0 = 1; 
...
Mesh = sqrt(A0 * NbPoints);

% Global parameters matching your target values
SEED = 89542; 
TIMEINTERVAL = 0.100000;
MINAREA = 28.125000;
MINLENGTH = 0.883883;
NEWEDGELENGTH = 1.767767;

TOTALTIME = 10.000000;
CURRENTTIME = 0.000000;  
INITIALSTEPSIZE = 0.000100; % Updated from 0.001
error_tolerance_absolute_mechanical = 0.010000; % Updated from 0.001

% Specific values for ALPHAM and TISSUE_ALPHA
ALPHAM = 0.282843;
TISSUE_ALPHA = 100.00;

TISSUE_EXT_STRESS_X = 0.000000;
TISSUE_EXT_STRESS_Y = 0.000000;    

% Specific Pressure/Tension parameters
P0 = 128.098648;
LAMBDA = 27.912724; 
Ratio = 0.300000; 
